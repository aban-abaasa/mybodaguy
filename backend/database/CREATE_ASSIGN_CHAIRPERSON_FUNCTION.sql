-- ==============================================
-- CREATE ASSIGN CHAIRPERSON FUNCTION
-- ==============================================
-- This creates the function needed to assign chairpersons
...
-- Drop ALL versions of assign_chairperson function
DROP FUNCTION IF EXISTS public.assign_chairperson CASCADE;

-- Create the assign_chairperson function with correct types
...
-- Grant permissions
GRANT EXECUTE ON FUNCTION public.assign_chairperson(UUID, TEXT, TEXT, UUID, DECIMAL, TEXT) TO authenticated;
GRANT EXECUTE ON FUNCTION public.assign_chairperson(UUID, TEXT, TEXT, UUID, DECIMAL, TEXT) TO service_role;

COMMIT;

-- Test query
SELECT 'Function created successfully! Table is now mbg_committee_members' as status;
