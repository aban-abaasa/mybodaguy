...
// The original 13-country curated list, kept first (and their exact string
// values UNCHANGED) since these are already stored as-is in the database
// (mbg_user_profiles.country, mbg_riders.operator_country, etc) — renaming
// any of them here would silently break every existing row that matches
// against this list by string equality. Everything after that is the rest
// of the world (real ISO 3166-1 countries), added so country/city pickers
// aren't artificially limited to this original set.
