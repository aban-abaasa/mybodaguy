import { Bike, Users, DollarSign, MapPin, LogOut } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="bg-white rounded-xl shadow-lg p-8 text-center">
          ...
          <h2 className="text-2xl font-bold text-slate-800 mb-2">Chairperson Dashboard</h2>
          <p className="text-slate-600 mb-4">Manage your region and track commissions</p>
